...
namespace BossAdreanlineMode
{
    internal class AdreanlineBar : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            area = new UIElement();
            area.Left.Set(-area.Width.Pixels - BossGUIConfig.Instance.AdreanlineBarX, 1f); // Place the resource bar to the left of the hearts.
            area.Top.Set(-area.Height.Pixels + BossGUIConfig.Instance.AdreanlineBarY - 60f, 0f); // Placing it just a bit below the top of the screen.
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 0; i < steps; i += 1)
            {
                ...
                {
                    spriteBatch.Draw(TextureAssets.MagicPixel.Value, new Rectangle(left + i, hitbox.Y, 1, hitbox.Height), Color.Lerp(new Color(224, 78, 42), new Color(255, 0, 0), percent));
                }
            }
        }
